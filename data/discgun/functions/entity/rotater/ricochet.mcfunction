...
# X軸
    ...
    execute if entity @s[tag=Col_Hit_X] store result entity @e[type=area_effect_cloud,tag=D.Gun_Rotater,limit=1,sort=nearest] Rotation[0] float -1 run data get entity @e[type=area_effect_cloud,tag=D.Gun_Rotater,limit=1,sort=nearest] Rotation[0]
...
# Z軸
    ...
    execute if entity @s[tag=Col_Hit_Z] store result entity @e[type=area_effect_cloud,tag=D.Gun_Rotater,limit=1,sort=nearest] Rotation[0] float -1 run data get entity @e[type=area_effect_cloud,tag=D.Gun_Rotater,limit=1,sort=nearest] Rotation[0]
    execute if entity @s[tag=Col_Hit_Z] as @e[type=area_effect_cloud,tag=D.Gun_Rotater,limit=1,sort=nearest] at @s run tp @s ~ ~ ~ ~180 ~
