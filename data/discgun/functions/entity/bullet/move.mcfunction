...
# 壁の衝突判定
    execute unless block ~ ~ ~ #discgun:no_collision run function discgun:entity/bullet/break
    
# 再帰
    execute if entity @s[scores={D.Gun_Recursion=1..,D.Gun_Range=1..}] at @s run function discgun:entity/bullet/move
