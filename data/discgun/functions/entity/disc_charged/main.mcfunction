...
# 移動
    ...
    execute rotated as @e[type=area_effect_cloud,tag=D.Gun_Rotater,tag=!D.Gun_Init,limit=1,sort=nearest] positioned ^ ^ ^-2 run particle firework ~ ~0.3 ~ 0.05 0.05 0.05 0 2 force
