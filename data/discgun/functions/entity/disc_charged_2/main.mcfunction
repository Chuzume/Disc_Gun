...
# 移動
    ...
    execute rotated as @e[type=area_effect_cloud,tag=D.Gun_Rotater,tag=!D.Gun_Init,distance=..3,sort=nearest,limit=1] positioned ^ ^ ^-2 run function discgun:entity/disc_charged_2/particle
# 壁反射
